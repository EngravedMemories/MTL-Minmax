...
parser.add_argument('--subset_id', default=15, type=int, help='mtan')
...
train_set = CIFAR100MTL(root='dataset', download=True, train=True, transform=trans_train, subset_id=opt.subset_id)
