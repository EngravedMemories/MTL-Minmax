...
parser = argparse.ArgumentParser(description='Multi-task Model Optimization: Pruning')
parser.add_argument('--weight', default='minmax', type=str, help='multi-task weighting: equal, uncert, dwa, minmax')
...
parser.add_argument('--prune-ratios', default=0.975, type=float, help ="define pruning ratios")
parser.add_argument('--dataroot', default='../nyuv2', type=str, help='dataset root')
parser.add_argument('--apply_augmentation', action='store_true', default='False', help='toggle to apply data augmentation on NYUv2')
...
if opt.apply_augmentation:
    ...
    print('MTAN-Applying data augmentation on NYUv2.')
else:
    nyuv2_train_set = NYUv2(root=dataset_path, train=True)
    print('MTAN-Standard training strategy without data augmentation.')
